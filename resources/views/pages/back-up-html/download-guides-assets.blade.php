                ...
                <div class="padding-top-30 padding-bottom-30 padding-left-20 padding-right-20 nav-holder">
                    ...
                    <div class="nav-list padding-bottom-30">
                        ...
                        <ul>
                            ...
                            <li><button data-scroll-to="scroll-to-jawsofbattle-app"><span class="inline-block-top">Jaws of Battle</span></button></li>
                        </ul>
                    </div>
            ...
            <div class="col-xs-12 col-md-9 page-content padding-left-0 padding-right-0">
                    ...
                    <div class="section-content">
                        ...
                        <div class="container-fluid">
                            <div class="row brochures-row padding-top-30 if-dentist">
                                <figure class="col-xs-12 col-sm-6 clear-hover en-brochure hover-on-desktop" id="scroll-to-dentist-en-brochure" itemscope="" itemtype="http://schema.org/ImageObject"><img alt="Brochure dentists EN" itemprop="contentUrl" src="https://dentists.dentacoin.com/assets/uploads/brochure-dentists-en.png" /> <a class="overlay-on-hover" href="https://dentacoin.com/assets/uploads/dentacoin-dentists-brochure.pdf" target="_blank"> <span class="lato-bold fs-16 dark-blue">Download Brochure (EN)</span></a></figure>

                                <figure class="col-xs-12 col-sm-6 clear-hover de-brochure" id="scroll-to-dentist-de-brochure" itemscope="" itemtype="http://schema.org/ImageObject"><img alt="Brochure dentists DE" itemprop="contentUrl" src="https://dentists.dentacoin.com/assets/uploads/brochure-dentists-de.png" /> <a class="overlay-on-hover" href="https://dentacoin.com/assets/uploads/dentacoin-broschuere-zahnaerzte.pdf" target="_blank"> <span class="lato-bold fs-16 dark-blue">Download Brochure (DE)</span> </a></figure>
                            </div>

                            <div class="row brochures-row padding-top-20 if-patient hide">
                                <figure class="col-xs-12 col-sm-6 clear-hover en-brochure hover-on-desktop" id="scroll-to-patient-en-brochure" itemscope="" itemtype="http://schema.org/ImageObject"><img alt="Brochure patients EN" itemprop="contentUrl" src="https://dentists.dentacoin.com/assets/uploads/brochure-patients-en.png" /> <a class="overlay-on-hover" href="https://dentacoin.com/assets/uploads/dentacoin-patient-brochure.pdf" target="_blank"> <span class="lato-bold fs-16 dark-blue">Download Brochure (EN)</span> </a></figure>

                                <figure class="col-xs-12 col-sm-6 clear-hover de-brochure" id="scroll-to-patient-de-brochure" itemscope="" itemtype="http://schema.org/ImageObject"><img alt="Brochure patients DE" itemprop="contentUrl" src="https://dentists.dentacoin.com/assets/uploads/brochure-patients-de.png" /> <a class="overlay-on-hover" href="https://dentacoin.com/assets/uploads/dentacoin-broschuere-patienten.pdf" target="_blank"> <span class="lato-bold fs-16 dark-blue">Download Brochure (DE)</span> </a></figure>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="scroll-to-section guides-section">
                    <div class="heading-line with-button">
                        ...
                        <div class="download-all"><a class="white-dark-blue-btn fs-16 white-border changeable-href-on-user-type-change" data-dentist="https://dentists.dentacoin.com/assets/uploads/dentists-tools-guide-kit.rar" data-patient="https://dentists.dentacoin.com/assets/uploads/patients-tools-guide-kit.rar" download="" href="https://dentists.dentacoin.com/assets/uploads/dentists-tools-guide-kit.rar">DOWNLOAD ALL PDF GUIDES</a></div>
                    </div>
                        ...
                        <section class="beige-bg" id="scroll-to-dcn-logo">
                            <div class="container-fluid">
                                <div class="row fs-0 padding-top-50 padding-bottom-50">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-lg-4 text-right inline-block text-center-xs padding-top-xs-25"><a class="white-dark-blue-btn fs-18 max-width-260 width-100 text-center" href="https://dentists.dentacoin.com/assets/uploads/dentacoin-logo.zip" target="_blank">DOWNLOAD LOGO</a></div>
                                </div>
                            </div>
                        </section>
                    </div>
