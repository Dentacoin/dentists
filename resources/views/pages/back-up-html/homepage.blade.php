@extends('layout')
@section('content')
    <section class="section-homepage-above-the-fold hide-on-hub-open">
    ...
    <section class="section-how-to-become-dcn-partner hide-on-hub-open">
    ...
    <section class="google-map-section padding-top-70 padding-top-xs-50 hide-on-hub-open" data-scroll-here="partners">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
    ...
    <section class="section-above-footer-options padding-top-80 padding-bottom-120 padding-bottom-xs-0 beige-bg hide-on-hub-open" data-scroll-here="contacts">
        <div class="container">
            <div class="row text-center fs-0">
                <div class="col-xs-12 col-sm-3 inline-block-bottom padding-bottom-xs-50 single-option">
                    <figure itemscope="" itemtype="http://schema.org/ImageObject"><a class="display-block" href="/download-guides-assets" target="_blank"><img alt="Document icon" class="max-width-60 max-width-xs-60 margin-bottom-15 margin-0-auto display-block" data-defer-src="/assets/uploads/assets1.svg" itemprop="contentUrl" /> </a>
