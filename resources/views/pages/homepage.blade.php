...
@section("content"){{--
    <section class="intro-section">
        ...
        <div class="container-fluid down-box padding-bottom-sm-20 padding-bottom-xs-30" data-scroll-here="bitcoin-dentistry">
            ...
            <div class="fs-16 fs-md-14 fs-xs-14 color-black calibri-light text-left">* Blockchain is just a new technology used for secure storage and exchange of data and value.</div>
        </div>
    ...
    <section class="applications-section padding-top-80 padding-top-xs-30 padding-bottom-80 padding-bottom-xs-30" data-scroll-here="tools">
        <div class="container">
            <div class="row text-center padding-bottom-70 padding-bottom-xs-30 color-white">
                ...
                <div class="col-xs-12 fs-20 fs-xs-18 lato-semibold padding-top-xs-10">Simple and free registration. No installations needed.</div>
            </div>
            <div class="row list">
