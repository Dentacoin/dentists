...
<head>
    ...
    @if((!(new \App\Http\Controllers\UserController())->checkSession() && !empty(Route::current()) && (Route::current()->getName() == 'home')) || ((new \App\Http\Controllers\UserController())->checkSession() && !empty(Route::current()) && (Route::current()->getName() == 'logged-home' || Route::current()->getName() == 'home')))
        <link rel="stylesheet" type="text/css" href="//dentacoin.com/assets/libs/dentacoin-mini-hub/css/styles-big-hub.css?v=1.0.77">
    @endif

    @if((new \App\Http\Controllers\UserController())->checkSession())
        <link rel="stylesheet" type="text/css" href="https://dentacoin.com/assets/libs/dentacoin-mini-hub/css/style.css?v=1.0.77">
    @elseif (!(new \App\Http\Controllers\UserController())->checkSession())
        <link rel="stylesheet" type="text/css" href="https://dentacoin.com/assets/libs/dentacoin-login-gateway/css/dentacoin-login-gateway-style.css?v=1.0.77"/>
    @endif
    <script>
...
<script src="https://dentacoin.com/assets/js/basic.js?v=1.0.77"></script>
...
@if((new \App\Http\Controllers\UserController())->checkSession() || (!(new \App\Http\Controllers\UserController())->checkSession() && !empty(Route::current()) && (Route::current()->getName() == 'home')))
    <script src="https://dentacoin.com/assets/libs/dentacoin-mini-hub/js/init.js?v=1.0.77"></script>
@endif
@if (!(new \App\Http\Controllers\UserController())->checkSession())
    <script src="https://dentacoin.com/assets/libs/dentacoin-login-gateway/js/init.js?v=1.0.77"></script>
@endif
