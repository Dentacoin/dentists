...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/dist/css/front-libs-style.css?v=1.0.52">
    <link rel="stylesheet" type="text/css" href="/assets/css/style.css?v=1.0.52">
    <script>
...
<body class="@if(!empty(Route::current())) {{Route::current()->getName()}} @else class-404 @endif @if((new \App\Http\Controllers\UserController())->checkSession()) logged-in @endif">
    ...
    @if(!(new \App\Http\Controllers\UserController())->checkSession())
        <script src="//dentacoin.com/assets/libs/civic-login/civic.js?v=1.0.52"></script>
        <script src="//dentacoin.com/assets/libs/facebook-login/facebook.js?v=1.0.52"></script>
