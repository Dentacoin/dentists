                        ...
                        <div class="step one">
                            ...
                            <div class="gdpr-checkbox padding-left-10 padding-right-10">
                                <div class="custom-checkbox-style module">
                                    <input type="checkbox" class="custom-checkbox-input" id="hs_legal_basis"/> <label for="hs_legal_basis" class="text-deco fs-16 padding-left-5 inline-block">By submitting the form, you agree to our <a href="//dentacoin.com/privacy-policy" target="_blank" class="lato-bold">Privacy Policy</a>.</label>
